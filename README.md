...
There is a newly added script to help you set up the hook. But it only support bare repositories.

```bash
./config_git.sh <bare repository directory>
```

follow the instructions and everything will be all set.
